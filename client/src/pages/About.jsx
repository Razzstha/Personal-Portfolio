  ...
  return (
    <section id="about" className="w-full bg-gray-900 text-gray-100 pt-10 pb-20 px-6">
      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <motion.div  className="mb-10"  initial="hidden"  whileInView="visible"
          viewport={{ once: true }}
          variants={{
            hidden: {},
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 text-center">
            ...
            {skills.map((skill, index) => (
              ...
              <motion.div key={index} className="flex flex-col items-center bg-gray-800 p-4 rounded-xl shadow hover:shadow-xl transition-transform transform hover:scale-110" initial={{ opacity: 0, y: 30 }}  whileInView={{ opacity: 1, y: 0 }}  transition={{ duration: 0.5, delay: index * 0.1 }}  viewport={{ once: true }}>
